...
function convertTextShapeToTldrawShape(
	...
	const unpositionedShape: TLTextShape = {
		...
		props: {
			...
			scale,
			richText,
			color: asColor(focusedShape.color ?? defaultTextShape.props?.color ?? 'color1_R1C1'),
			textAlign,
			autoSize,
	...
	return {
		shape: {
			...
			props: {
				...
				color: asColor(focusedShape.color ?? defaultLineShape.props?.color ?? 'color1_R1C1'),
...
function convertArrowShapeToTldrawShape(
	...
	const shape = {
		...
		props: {
			...
			color: asColor(focusedShape.color ?? defaultArrowShape.props?.color ?? 'color1_R1C1'),
			...
			labelColor: defaultArrowShape.props?.labelColor ?? 'color1_R1C1',
	...
	return {
		shape: {
			...
			props: {
				...
				color: asColor(focusedShape.color ?? defaultGeoShape.props?.color ?? 'color1_R1C1'),
				...
				labelColor: defaultGeoShape.props?.labelColor ?? 'color1_R1C1',
				richText,
...
function convertNoteShapeToTldrawShape(
	...
	return {
		shape: {
			...
			props: {
				color: asColor(focusedShape.color ?? defaultNoteShape.props?.color ?? 'color1_R1C1'),
				richText,
				...
				labelColor: defaultNoteShape.props?.labelColor ?? 'color1_R1C1',
	...
	return {
		shape: {
			...
			props: {
				...
				color: asColor(focusedShape.color ?? defaultDrawShape.props?.color ?? 'color1_R1C1'),
				fill,
			},
			meta: {
