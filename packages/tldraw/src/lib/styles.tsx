...
export const STYLES = {
	color: [
		...
		// Extended colors
		{ value: 'dark-blue', icon: 'color' },
		{ value: 'teal', icon: 'color' },
		{ value: 'cyan', icon: 'color' },
		{ value: 'lime', icon: 'color' },
		{ value: 'dark-green', icon: 'color' },
		{ value: 'brown', icon: 'color' },
		{ value: 'tan', icon: 'color' },
		{ value: 'pink', icon: 'color' },
		{ value: 'magenta', icon: 'color' },
		{ value: 'purple', icon: 'color' },
		{ value: 'indigo', icon: 'color' },
		{ value: 'dark-red', icon: 'color' },
		{ value: 'maroon', icon: 'color' },
		{ value: 'gold', icon: 'color' },
		{ value: 'silver', icon: 'color' },
	],
	fill: [
